...
void ignore_manual(void){
    fputs(
        ...
        "  -E, --equivalent-to=COMMAND    add NAMEs as commands that have the same setting as COMMAND\n"
        "\n"
        "Options for Condition Specification:\n"
        "  -A, --additional-settings      accept the specification of the conditions for ignoring\n"
        "      --detect-anymatch          change how to use the conditions for ignoring (details below)\n"
