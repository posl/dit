...
void ignore_manual(void){
    fputs(
        ...
        "      --target=FILE              determine the target file:\n"
        "                                 " TARGET_OPTION_ARGS
        "  -i, --invert                   receive commands that should be reflected\n"
        ...
        "  -E, --equivalent-to=COMMAND    enumerate NAMEs that have the same setting as COMMAND\n"
        "\n"
        "Options for Condition Specification:\n"
        "  -A, --additional-settings      accept the specification of the conditions for ignoring\n"
        "      --detect-anymatch          set the mode to detect if any condition is matched\n"
        ...
        "  - If either of '-npE' is given, the non-optional arguments other than NAME make no sense.\n"
        ...
        "  - By default, the conditions are used to determine whether to reflect the command line by\n"
        "    determining whether it contains elements that any of them do not apply, but when\n"
        "    '--detect-anymatch' is given, this specification can be changed to determine that by\n"
        "    determining whether the command line contains elements that any of the conditions apply.\n"
