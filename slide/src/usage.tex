...
\begin{frame}[fragile]{手順 １/４\\「提案ツールのソースコードを取得する」}
...
\begin{frame}{手順 ２/４\\「開発用のコンテナを起動し，開発を開始する」}
...
\begin{frame}{手順 ３/４\\「動作確認しながら，目的の環境構築を行う」}
...
\begin{frame}{手順 ４/４\\「Dockerfileを完成させる」}
    次の処理は，提案ツールの機能を使う．
