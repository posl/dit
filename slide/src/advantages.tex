...
\begin{frame}{現状のイメージ開発の問題点}
    ...
    \begin{tikzpicture}[remember picture]
        ...
        \begin{scope}[shift={(current page.south west)}]
            \only<2>{\node[probrem] at (6.4, 4.6) {２つの問題が発生};}
        \end{scope}
    \end{tikzpicture}
\end{frame}


\begin{frame}{問題 １/２\\「Dockerfileの動作確認のオーバヘッド」}
    \vskip1.0zh
...
\begin{frame}{問題 ２/２\\「Dockerfile開発時の開発者の負担」}
    \vskip1.0zh
