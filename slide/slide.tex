...
\begin{frame}{今後の展望}
    \begin{itemize}
        ...
        \item 既存の機能を少し豪華にする．
        \begin{itemize}
            \item 対応するパッケージマネージャの種類を増やす．
            \item copy関連のリファクタリング・最適化機能を増やす．
        \end{itemize}
...
\begin{frame}{基本情報}
    \begin{itemize}
        ...
        \end{itemize}
        \item ツールの機能の利用は，busyboxと同じような形式で/usr/local/binにあるdit\footnotemark[1]コマンドから行う．
...
\begin{frame}{機能３\\「ホスト環境からファイルをコピーする」}
...
\begin{frame}{機能３\\「パッケージをインストールする」}
